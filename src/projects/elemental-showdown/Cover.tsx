...
// The Tug in miniature, sized in `cqw` so it holds its proportions at any
// width. `--cover-seam` is where fire meets water: one transition on it carries
// the fire's edge, the seam and the pill together.
